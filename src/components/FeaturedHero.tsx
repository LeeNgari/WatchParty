    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center px-4 lg:px-16">
        <div className="max-w-2xl space-y-8">
          ...
          <div className="flex gap-4">
            <button 
              onClick={handlePlay}
              className="flex items-center gap-3 bg-white text-black px-8 py-4 rounded-lg font-semibold hover:bg-gray-200 transition-all duration-200 transform hover:scale-105"
            >
            ...
            <button 
              onClick={handleInfo}
              className="flex items-center gap-3 bg-gray-700/80 backdrop-blur-sm text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-600/80 transition-all duration-200"
            >
      ...
      <div className="absolute bottom-8 right-8 flex gap-3 z-20">
        <button 
          ...
          className="w-12 h-12 bg-gray-900/80 backdrop-blur-sm hover:bg-gray-800 rounded-full flex items-center justify-center transition-all duration-200"
        >
      ...
      {/* Progress Indicators */}
      <div className="absolute bottom-8 left-4 lg:left-16 flex gap-2 z-20">
        {content.map((_, index) => (
          <button
            key={index}
